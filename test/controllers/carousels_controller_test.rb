...
class CarouselsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carousel" do
    assert_difference('Carousel.count') do
      post carousels_url, params: { carousel: { src: @carousel.src, title: @carousel.title, url: @carousel.url } }
    end
  ...
  test "should update carousel" do
    patch carousel_url(@carousel), params: { carousel: { src: @carousel.src, title: @carousel.title, url: @carousel.url } }
